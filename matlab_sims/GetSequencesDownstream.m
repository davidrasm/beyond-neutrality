function data = GetSequencesDownstream(data, node_num, init_seq, b, d, m, names, names_numerical, epi_params)
...
if branchorleaf1 > epi_params.n 
    data = GetSequencesDownstream(data, node_num1, data(branchorleaf1).Sequence, b, d, m, names, names_numerical, epi_params);
end
if branchorleaf2 > epi_params.n 
    data = GetSequencesDownstream(data, node_num2, data(branchorleaf2).Sequence, b, d, m, names, names_numerical, epi_params);
end
